...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__core_core_module__ = __webpack_require__(105);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api_service__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__map_service__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__geolocation_service__ = __webpack_require__(98);
...
CoreModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
        ...
        declarations: [],
        providers: [__WEBPACK_IMPORTED_MODULE_2__api_service__["a" /* ApiService */], __WEBPACK_IMPORTED_MODULE_3__map_service__["a" /* MapService */], __WEBPACK_IMPORTED_MODULE_4__geolocation_service__["a" /* GeolocationService */]]
    })
], CoreModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_toPromise__ = __webpack_require__(167);
...
var ApiService = (function () {
    ...
    ApiService.prototype.getNearbySpots = function (lat, lng) {
        return this.http.post(this.url + "/nearby-spots", {
            location: [lat, lng]
        }).map(function (r) { return r.json(); }).toPromise();
    };
    ApiService.prototype.createSpot = function (name, lat, lng) {
...
var GeolocationService = (function () {
    ...
    GeolocationService.prototype.getCoordinates = function () {
        ...
        return new Promise(function (res, rej) {
            _this.geo.getCurrentPosition(res, rej);
        });
    };
...
var MapService = (function () {
    ...
    MapService.prototype.init = function (selector, lat, lng, zoom) {
        if (lat === void 0) { lat = 42.4401433; }
        if (lng === void 0) { lng = -79.3362631; }
    ...
    MapService.prototype.addMarker = function (label, lat, lng) {
